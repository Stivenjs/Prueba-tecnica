...
namespace SegurosAPI.DTOs.Requests
{
    ...
    /// </summary>
    public class CreateAseguradoRequest
    {
        [Required(ErrorMessage = "El número de identificación es requerido")]
        [Range(1, 9999999999, ErrorMessage = "El número de identificación debe ser válido")]
        [SwaggerSchema(Description = "Número de identificación del asegurado", Format = "int64")]
        public long NumeroIdentificacion { get; set; } = 1044603501;
